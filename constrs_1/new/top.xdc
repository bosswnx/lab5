set_property PACKAGE_PIN P5 [get_ports {numIn0[3]}]
set_property PACKAGE_PIN P4 [get_ports {numIn0[2]}]
set_property PACKAGE_PIN P3 [get_ports {numIn0[1]}]
set_property PACKAGE_PIN P2 [get_ports {numIn0[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {numIn0[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {numIn0[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {numIn0[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {numIn0[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {numIn1[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {numIn1[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {numIn1[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {numIn1[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {pos0[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {pos0[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {pos0[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {pos0[0]}]
...
set_property PACKAGE_PIN G2 [get_ports {pos0[3]}]
set_property PACKAGE_PIN C2 [get_ports {pos0[2]}]
set_property PACKAGE_PIN C1 [get_ports {pos0[1]}]
set_property PACKAGE_PIN H1 [get_ports {pos0[0]}]
...
set_property PACKAGE_PIN R2 [get_ports {numIn1[3]}]
set_property PACKAGE_PIN M4 [get_ports {numIn1[2]}]
set_property PACKAGE_PIN N4 [get_ports {numIn1[1]}]
set_property PACKAGE_PIN R1 [get_ports {numIn1[0]}]
